...
public class DbRestaurantOrderLoader {
	...
	private void loadItem() {
		...
		addItem(increaseIdincreased(), "Микроавтобус Hyundai H350", (float) 72000, "Микроавтобус",
		...
		addItem(increaseIdincreased(), "Мерседес спринтер 2", (float) 65000, "Микроавтобус",
		...
		addItem(increaseIdincreased(), "Микроавтобус Citroen Jumpy 3", (float) 60000, "Микроавтобус",
		...
		addItem(increaseIdincreased(), "Микроавтобус Газель-Бизнес", (float) 40000, "Микроавтобус",
		...
		addItem(increaseIdincreased(), "Микроавтобус Соболь", (float) 45000, "Микроавтобус",
		...
		addItem(increaseIdincreased(), "1-ый Микроавтобус Мерседес бенз", (float) 68000, "Микроавтобус",
		...
		addItem(takeDefaultIdIncreased(), "Небольшой междугородец МАЗ-232", (float) 100000, "Автобус",
		...
		addItem(increaseIdincreased(), "Туристические MAN Lions Coach", (float) 120000, "Автобус",
		...
		addItem(increaseIdincreased(), "Люксбус Volvo 9900", (float) 150000, "Автобус",
		...
		addItem(increaseIdincreased(), "Комфортабельный Volvo 9700", (float) 200000, "Автобус",
		...
		addItem(increaseIdincreased(), "Межгород-турист", (float) 230000, "Автобус",
		...
		addItem(increaseIdincreased(), "Туристическое Scania-3 ЛИАЗ", (float) 235000, "Автобус",
		...
		addItem(increaseIdincreased(), "Компактный МАЗ-241", (float) 60000, "Автобусы малого класса",
		...
		addItem(increaseIdincreased(), "Абтобус BAW Street", (float) 40000, "Автобусы малого класса",
		...
		addItem(increaseIdincreased(), "Городской автобус", (float) 45000, "Автобусы малого класса",
		...
		addItem(increaseIdincreased(), "Универсальный Hyundai County", (float) 55000, "Автобусы малого класса",
		...
		addItem(increaseIdincreased(), "Удлиненный ПАЗ-4234", (float) 40000, "Автобусы малого класса",
		...
		addItem(increaseIdincreased(), "Полноприводный ПАЗ-3206", (float) 1.00, "Автобусы малого класса",
