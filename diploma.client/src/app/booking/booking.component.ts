...
export class BookingComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
    ...
    this.bookingService.booking.name = this.userForm.getRawValue().recordName;
    this.bookingService.booking.surname = this.userForm.getRawValue().recoredSurname;
  ...
  showResponseAlert(response) {
    ...
    dialogConfig.width = '50%';
    dialogConfig.data = {
      response: response, booking: this.bookingService.booking
    };
