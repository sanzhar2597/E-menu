export class Languages {
  public RU_LANGUAGE = {
    ...
    bookingorders: "Заказы бронирования",
    close: "Закрыть",
    exit: "Выйти",
    ...
    fromcity:"Откуда",
    tocity:"Куда",
    datereserv:"Дата отправки",
    firstename:"Имя",
    secondename:"Фамилия",
    phonexnumber:"Номер телефона",
    placenumber:"Номер месты",
    customer: "Пользователь",
    pmethod: "Способ оплаты",
    gtotal: "Общий счет",
    createnew: "Бронировать еще",
    fooditem: "Транспорт",
    select: "Выбор",
    price: "Цена",
    quantity: "Количество",
  ...
  public EN_LANGUAGE = {
    ...
    diploma: "Diploma",
    orderfooditem: "Order transport item",
    orderno: "Order no.",
    fromcity:"From",
    tocity:"To",
    datereserv:"Date of reservation",
    firstename:"Firstname",
    secondename:"Lastname",
    phonexnumber:"Phone Number",
    ...
    nofooditemselectd: " No transport item selected for this order.",

    abouttext: 'You can order transport here for turism, or booking place fo intercity transport',
